...
const verifySellerApplication = id => {
...
const UserApplication = () => {
  ...
  const verifySeller = a => {
    verifySellerApplication(a._id).then(data => {
      console.log(data);
              ...
              <tbody>
                {applications.map((a, aIndex) => (
                  <tr>
                    ...
                    <td>
                      <button
                        onClick={() => verifySeller(a)}
                        className="btn btn-sm btn-outline-warning btnSm pl-3 pr-3"
                      >
                        Verify
                      </button>
                    </td>
